...
insert into public.topics (slug, name, blurb, sort_order, published) values
  ('seedbot', 'Design a Seed Traveler', 'Seeds cannot walk. Engineer one a way to move.', 1, true),
  ...
  ('myplate', 'Build a Plate', 'Five groups, one plate, and half of it colored in.', 5, true),
  ...
  ('compost', 'What Compost Eats', 'Trash in one end, soil out the other, and something alive doing the work.', 11, true),
